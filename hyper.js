...
module.exports = {
  config: {
    ...
    // pokemon: 'charmeleon', // Define your favorite pokemon theme!
  ...
  //   `@company/project`
  //   `project#1.0.1`
  plugins: [//"hyperterm-transparent-bg",
  // "hyper-pokemon", //"hyper-blink",
  // "hyper-search", //"hyper-statusline",
  "hyperterm-tab-icons", "hyper-alt-click"
  //, "hyper-history"
  ],
